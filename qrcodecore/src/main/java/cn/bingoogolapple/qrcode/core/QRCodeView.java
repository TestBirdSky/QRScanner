...
public abstract class QRCodeView extends RelativeLayout implements Camera.PreviewCallback {
    ...
    protected boolean transformToViewCoordinates(final PointF[] pointArr, final Rect scanBoxAreaRect, final boolean isNeedAutoZoom, final ScanResult result) {
    ...
    private boolean handleAutoZoom(PointF[] locationPoints, final ScanResult result) {
    ...
    private void startAutoZoom(int oldZoom, int newZoom, final ScanResult result) {
